...
**Submitted by**: Natnael Samson (nsamson4)

**Group Members:** Bisrat Tadesse (bisrat), Natnael Samson (nsamson4), Habeke Mesfin (hmesfin7)

**App Description:** Allows users to search GitHub profiles, view recent repositories, and store/retrieve search history with MongoDB.

**YouTube Video Link:** https://youtu.be/WsVxSSIJje8

**APIs:** GitHub REST API (https://api.github.com/)

**Contact Email:** bisrat@umd.edu, hmesfin7@umd.edu, nsamson4@umd.edu

**Deployed App Link:** https://github-profile-tracker-4qlv.onrender.com/

**AI Use:** OpenAI's ChatGPT 5.5
